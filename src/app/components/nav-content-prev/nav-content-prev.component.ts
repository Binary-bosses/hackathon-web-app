...
@Component({
  selector: 'app-nav-content-prev',
  templateUrl: './nav-content-prev.component.html',
  styleUrls: ['./nav-content-prev.component.css']
})
export class NavContentPrevComponent implements OnInit {
    @Input()
